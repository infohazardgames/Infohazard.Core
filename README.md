# HazardCore: a collection of useful functionality for Unity, which is used by my other packages.
...
4. Paste in `https://github.com/vcmiller/HazardCore.git`.
5. Click Add.
...
2. Using your preferred git client or the command line, add `https://github.com/vcmiller/HazardCore.git` as a submodule in your project's Packages folder.
